...
v_time_in_secs := round((to_date(to_char(v_end_interval_time,'DD-MON-YY HH24:MI:SS'),'DD-MON-YY HH24:MI:SS') - to_date(to_char(v_begin_interval_time,'DD-MON-YY HH24:MI:SS'),'DD-MON-YY HH24:MI:SS'))*24*60*60,0);
